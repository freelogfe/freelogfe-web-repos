...
import { resourcePolicyVisitor } from '@freelog/resource-policy-lang/gen/resourcePolicyVisitor'
import camelcase from 'camelcase'
import event_def from 'freelog_event_definition/lib/event_definition'

export default class HighlightGenerator extends resourcePolicyVisitor {
  constructor() {
    super()
    // highlight
