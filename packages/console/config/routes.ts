      ...
      {exact: true, path: 'storage', component: '../pages/storage', title: '存储空间 - Freelog'},
      {
        ...
        routes: [
          ...
          },
          {
            path: 'exhibit',
            routes: [
              {path: 'formal/:id', exact: true, component: '../pages/node/exhibit/formal/$id', title: '展品管理 - Freelog'},
              {path: 'informal/:id', exact: true, component: '../pages/node/exhibit/informal/$id', title: '测试展品管理 - Freelog'},
              {component: '../pages/exception/404'},
            ]
          },
          {component: '../pages/exception/404'},
