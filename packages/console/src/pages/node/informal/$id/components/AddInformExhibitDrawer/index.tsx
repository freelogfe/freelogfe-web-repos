...
function FAddInformExhibitDrawer({
  ...
  return (<FDrawer
    title={isTheme ? fI18nNext.t('import_test_theme') : '添加测试展品'}
    visible={visible}
    ...
    list = (data.dataList as any[])
      ...
      .map<FAddInformExhibitDrawerStates['list'][number]>((rs) => {
        ...
        if (usedResourceIDs.includes(rs.resourceId)) {
          disabled = true;
          disabledReason = fI18nNext.t('tag_added');
        }
    ...
    list = (data.dataList as any[])
      ...
      .map<FAddInformExhibitDrawerStates['list'][number]>((rs) => {
        ...
        if (usedResourceIDs.includes(rs.resourceId)) {
          ...
          disabled = true;
          disabledReason = fI18nNext.t('alarm_resource_unreleased ');
        }
        return {
          id: rs.resourceId,
          disabled,
      ...
      list = (data.dataList as any[])
        ...
        .map<FAddInformExhibitDrawerStates['list'][number]>((ob) => {
          ...
          if (usedObjectIDs.includes(ob.objectId)) {
            ...
            disabled = true;
            disabledReason = fI18nNext.t('msg_set_resource_type');
          }
