  ...
  return (<div className={styles.block}>
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      <FComponentsLib.FContentText
        text={FI18n.i18nNext.t('edit_exhibit_authplan')}
        type={'highlight'}
      />

      {
        ...
        >
          {/*添加授权策略*/}
          {FI18n.i18nNext.t('edit_exhibit_authplan_btn_add')}
    ...
    <div style={{ height: 20 }} />
    {
      exhibitInfoPage.policy_List.length === 0 && (<div className={styles.empty}>
        <div style={{ height: 10 }} />
        {
          FI18n.i18nNext.t('edit_exhibit_authplan_info').split('<br />')
            .map((text) => {
        ...
        >
          <FComponentsLib.FRectBtn
            ...
            type='primary'
          >{FI18n.i18nNext.t('edit_exhibit_authplan_btn_add')}</FComponentsLib.FRectBtn>
        </FComponentsLib.FHotspotTooltip>
        <div style={{ height: 20 }} />
      </div>)
    }
