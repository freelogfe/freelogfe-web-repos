...
function Bottom({dispatch, marketResourcePage}: BottomProps) {
  ...
  const resourcePolicyNums = marketResourcePage.signResources.map((sr) => sr.policies.filter((srp) => srp.checked).length);
  console.log(resourcePolicyNums, 'resourcePolicyNums0329');
