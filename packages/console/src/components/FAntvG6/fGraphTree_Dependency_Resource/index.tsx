...
interface fGraphTree_Dependency_Resource_Props {
  resourceID: string;
  version: string;
}

function fGraphTree_Dependency_Resource({
                                          resourceID,
                                          version,
                                        }: fGraphTree_Dependency_Resource_Props): Promise<boolean> {
...
export default fGraphTree_Dependency_Resource;
