...
interface fGraphTree_Relationship_Exhibit_Props {
  exhibitID: string;
  version: string;
}

function fGraphTree_Relationship_Exhibit({ exhibitID, version }: fGraphTree_Relationship_Exhibit_Props) {
...
export default fGraphTree_Relationship_Exhibit;
