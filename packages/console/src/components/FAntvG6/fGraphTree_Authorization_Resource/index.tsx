...
interface fGraphTree_Authorization_Resource_Props {
  resourceID: string;
  version: string;
}

function fGraphTree_Authorization_Resource({
                                             resourceID,
                                             version,
                                           }: fGraphTree_Authorization_Resource_Props): Promise<boolean> {
...
export default fGraphTree_Authorization_Resource;
