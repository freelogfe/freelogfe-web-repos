...
import { OnChange_ShowPage_Action, OnMount_Page_Action, OnUnmount_Page_Action } from '@/models/settingPage';
  ...
  return (<div className={styles.styles}>
    <div className={styles.header}>
      ...
      <a
        ...
        className={settingPage.showPage === 'security' ? styles.active : ''}>账号安全</a>
      <div style={{ width: 30 }} />
      <a
        onClick={() => {
        ...
        className={settingPage.showPage === 'privacy' ? styles.active : ''}>隐私</a>
    </div>
