      ...
      >
        ...
        <div className='flex-column rule w-100x align-center' id='inner-test'>
          ...
          <div className='flex-column container space-between'>
            <span className=''>
              1.&nbsp; &nbsp;内测活动时间：{activityDetailsPage.startTime?.format('YYYY/MM/DD') || 'YYYY/MM/DD'} - {activityDetailsPage.endTime?.format('YYYY/MM/DD') || 'YYYY/MM/DD'}；
            </span>
            <span className=''>
              2.&nbsp;
            ...
            <span className=''>
              5.&nbsp;
              &nbsp;随机抽取4位成功邀请好友的用户赠送价值400元的京东购物卡（电子卡），中奖用户名单将于{activityDetailsPage.announceTime?.format('YYYY年MM月DD日') || 'YYYY年MM月DD日'}公布；
            </span>
