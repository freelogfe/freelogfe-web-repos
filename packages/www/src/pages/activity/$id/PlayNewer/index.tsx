...
function PlayNewer({}: PlayNewerProps) {
  ...
  return (
    <div className={'play-newer w-100x h-100x flex-column align-center'}>
      <div  className="red-pack flex-row align-center p-15" onClick={()=> scrollToAnchor('inner-test')}>
        <div className="h-40 over-h">
          <img src={redpacket} alt="" className="h-100x" />
        </div>
        <div className="h-24 over-h ml-14">
        ...
        <div className="flex-row space-between w-100x">
          ...
          <div className="flex-column">
            ...
            <div className="flex-row  mb-15">
              <div className="titleLabel2"></div>
              <span className="title2">节点商是平台资源的整合、运营推广者</span>
            </div>
            <div className="flex-row  mb-15">
              <div className="titleLabel2"></div>
              <span className="title2">
