    ...
    <div className={'play-newer w-100x h-100x flex-column align-center'}>
      ...
      <div className='w-100x test-wrap' style={{ zIndex: 20 }}>
        <div className=' flex-column align-center py-60 pl-190 pr-160 test'>
          ...
          <div className='flex-row space-between w-100x'>
            <div className='flex-column'>
              <span className='title'>一、漫画、小说家集结，参与赢&nbsp;<label
                style={{ fontSize: 34, color: '#E9A923', fontWeight: 600 }}>2000元</label>&nbsp;现金奖</span>
              ...
              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>一等奖2000元</span>
              <div style={{ height: 4 }} />
              <span className='content2'>漫画、小说两个赛道中，排名第一的资源作者可分别获得2000元现金奖励</span>

              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>二等奖1000元</span>
              <div style={{ height: 4 }} />
              <span className='content2'>漫画、小说两个赛道中，排名第2-3名的资源作者可分别获得1000元现金奖励</span>

              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>三等奖500元</span>
              <div style={{ height: 4 }} />
              <span className='content2'>漫画、小说两个赛道中，排名第4-8名的资源作者可分别获得500元现金奖励</span>

              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>优秀奖200元</span>
              <div style={{ height: 4 }} />
              <span className='content2'>漫画、小说两个赛道中，排名第9-18名的资源作者可分别获得200元现金奖励</span>

              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>普照奖</span>
              <div style={{ height: 4 }} />
              <span
                className='content2'>每创建并发行1个合规资源可领取5—20元现金奖励，其中游戏类资源可获得20元，漫画、小说、图片等其他类型可获得5元(同一用户限领3次资源发行奖励)</span>

              <span style={{ color: '#E9A923', fontWeight: 600, fontSize: 16, lineHeight: '22px' }}>幸运奖</span>
              <div style={{ height: 4 }} />
              <span className='content2'>每周抽取一位上周参与排名活动的幸运鹅，赠送价值100元的京东购物卡</span>
            </div>
          ...
          <div className='flex-row space-between w-100x align-center mb-30 '>
            <div className='flex-column align-center w-600 ml-30'>
              <div className='title'>三、邀请好友，赢&nbsp;<label
                style={{ fontSize: 34, color: '#E9A923', fontWeight: 600 }}>400元</label>&nbsp;京东购物卡</div>
              <div className='content mt-30 text-break text-align-center'>
          ...
          <div className='flex-row space-between w-100x align-center '>
            ...
            <div className='flex-column align-center w-600 mr-30'>
              <div className='title'>四、参与问卷调研，领&nbsp;<label
                style={{ fontSize: 34, color: '#E9A923', fontWeight: 600 }}>6元</label>&nbsp;现金奖</div>
              <div className='content mt-30 text-break text-align-center'>
