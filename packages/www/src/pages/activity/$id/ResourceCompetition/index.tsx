          ...
          <div className={styles.regulationContent}>
            <div className={styles.regulationItem}>
              ...
              <div className={styles.text}>
                <span>
                  活动投稿时间：2021年***00:00至2021年***24:00，投稿时间以资源发行时间为准。
                </span>
              </div>
            </div>
            <div style={{ height: 20 }} />
            <div className={styles.regulationItem}>
              ...
              <div className={styles.text}>
                <span>
                  结果公示时间：****，获奖结果将在Freelog主站活动页中公示。每周幸运奖获奖名单将于每周一在本活动页中的置顶讨论区、个人主页的公告栏中公示，奖励将于活动结果公示后的7个工作日内发放。
                </span>
              </div>
            </div>
            <div style={{ height: 20 }} />
              ...
              <div className={styles.text}>
                <span>
                  ...
                  <FComponentsLib.FCopyToClipboard
                    text={'内测集结！漫画家召集令'}
                    title={'点击复制标签'}
                  ><b style={{ cursor: 'pointer' }}>#内测集结！漫画家召集令#</b></FComponentsLib.FCopyToClipboard>{' '}
                  活动标签，以JPG、PNG长图格式上传，单张漫画内容需不少于10格；小说资源需选择资源类型“阅读-文章”，同时添加{' '}
                  <FComponentsLib.FCopyToClipboard
                    text={'内测集结！小说家召集令'}
                    title={'点击复制标签'}
                  ><b style={{ cursor: 'pointer' }}>#内测集结！小说家召集令#</b></FComponentsLib.FCopyToClipboard>{' '}
