...
function FighterRegistration({}: FighterRegistrationProps) {
  ...
  return (<div className={styles.registration}>
    ...
    <FComponentsLib.FTextBtn
      type={'primary'}
      onClick={() => {
        self.open(self.location.pathname.endsWith('.freelog.com') ? 'https://www.freelog.com/activity/65b0c90ec759060039cc61b9' : 'https://www.testfreelog.com/activity/65b0c790435d96002f7b8358');
      }}
